...
export class PredictionService {
    ...
    // Feature 12: Physical Exertion (use today's data)
    const exertion = this.getPhysicalExertionForDate(entries, today);
    ...
    // Exertion factors
    if (exertion > 0.7) factors.push("Effort physique intense");
